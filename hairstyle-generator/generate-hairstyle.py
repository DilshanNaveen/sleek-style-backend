...
def main(args):
    ...
    im_path2 = os.path.join(args.sample_sets, args.im_path2)
    im_path3 = os.path.join(args.sample_sets, args.im_path2)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='SleekStyle')

    parser.add_argument('--input_dir', type=str, default='input',
                        help='The directory of the images to be inverted')
    parser.add_argument('--sample_sets', type=str, default='sample-sets',
                        help='The directory of the sample-sets to be inverted')
    ...
    parser.add_argument('--ckpt', type=str, default="trained_models/ffhq.pt")
    ...
    parser.add_argument('--seg_ckpt', type=str, default='trained_models/seg.pth')
